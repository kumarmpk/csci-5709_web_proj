...
var modifyActiveSprint = (req, res) => {
    ...
    if (!req.body.hasOwnProperty("sprintname") || !req.body.hasOwnProperty("startdate") || !req.body.hasOwnProperty("enddate") || !req.body.hasOwnProperty("description") || !req.body.hasOwnProperty("projectID") || !req.body.hasOwnProperty("sprintID") || req.body['sprintname'] == '' || req.body['startdate'] == '' || req.body['enddate'] == '') {
        return res
            .status(400)
    ...
    connectionObject.query(updateActiveSprint, sprint_details, (err, result) => {
        ...
        if (result.affectedRows == 0) {
            ...
            res.status(200).json({ msg: `Active sprint with sprintID: ${req.body.sprintID} successfully modified!` });
        }
    });
